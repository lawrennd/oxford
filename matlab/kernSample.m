function f = kernSample(kernType, numSamps, params, lims, seed, bw)
...
if bw
  ...
  print('-deps', ['../tex/diagrams/kernSample' KernType infoStr paramStr ...
                  'bw.eps']);
else
  print('-depsc', ['../tex/diagrams/kernSample' kernType paramStr ...
                  '.eps']);
end
